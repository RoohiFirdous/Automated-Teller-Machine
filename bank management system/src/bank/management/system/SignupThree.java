...
public class SignupThree extends JFrame implements ActionListener{
    ...
    JLabel l1, type, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12;
    ...
    SignupThree(String formno){
        ...
        l3.setBounds(100, 240, 300, 30);
        add(l3);
        
        l4 = new JLabel("XXXX-XXXX-XXXX-4184");
        l4.setFont(new Font("Raleway", Font.BOLD, 22));
        l4.setBounds(330, 240, 300, 30);
        add(l4);
        
        
        l5 = new JLabel("(Your 16-digit Card number)");
        l5.setFont(new Font("Raleway", Font.BOLD, 12));
        l5.setBounds(100, 270, 300, 20);
        add(l5);
...
//        
        ...
        l8.setBounds(330, 300, 300, 30);
        add(l8);
    
        l9 = new JLabel("(4-digit password)");
        l9.setFont(new Font("Raleway", Font.BOLD, 12));
        l9.setBounds(100, 330, 300, 20);
        add(l9);
    
        l10 = new JLabel("Services Required:");
        l10.setFont(new Font("Raleway", Font.BOLD, 22));
        l10.setBounds(100, 360, 400, 30);
        add(l10);
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    Conn conn = new Conn(); 
                    String q1 = "insert into signupthree values('"+formno+"','"+atype+"','"+cardno+"','"+pinno+"','"+facility+"')";  
